...
\begin{frame}[allowframebreaks]{Was ist elektrischer Strom?}
    \begin{columns}
        ...
        \column{.6\textwidth}
        \raisebox{-0.5\height}{\includegraphics[width=.6\textwidth]{02-hardwaredesign/img/atom_detail}}

        \column{.4\textwidth}
        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{02-hardwaredesign/img/atom_kern}}
        \hskip 1em
        Atomkern \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{02-hardwaredesign/img/atom_schale}}
        \hskip 1em
        Schale \\
        \bigskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{02-hardwaredesign/img/atom_elektron}}
        \hskip 1em
        Elektron \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{02-hardwaredesign/img/atom_proton}}
        \hskip 1em
        Proton \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{02-hardwaredesign/img/atom_neutron}}
        \hskip 1em
        Neutron \\
    \end{columns}
    ...
    \begin{columns}
        ...
        \begin{center}
            \includegraphics[width=.7\textwidth]{02-hardwaredesign/img/atom_elektronenfluss}
        \end{center}
    \end{columns}
...
\begin{frame}{Schaltpläne zur Dokumentation von Stromkreisen}
    \begin{center}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/mini-stromkreis}
    \end{center}
    ...
    \parbox{\linewidth}{
        ...
        \begin{center}
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/schaltsymbole}
        \end{center}
    }
\end{frame}
...
\begin{frame}[allowframebreaks]{Das Ohmsche Gesetz}
    \begin{columns}
        \column{.4\textwidth}
        \begin{center}
            \includegraphics[width=.4\textwidth]{02-hardwaredesign/img/formel_uri}
        \end{center}
        ...
        \column{0.6\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/ohmsches-gesetz-schaltplan}
    ...
    }
    {
        ...
        \begin{columns}
            \column{.33\textwidth}
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/kennlinie-widerstand} \\
            \smallskip
            \hfill \textbf{Widerstand} \hfill%
            \raisebox{-0.4\height}{\includegraphics[width=2.5em]{02-hardwaredesign/img/komponenten_elementar_widerstand}}


            \column{.33\textwidth}
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/kennlinie-diode} \\
            \smallskip
            \hfill \textbf{Leuchtdiode} \hfill%
            \raisebox{-0.4\height}{\includegraphics[width=2.5em]{02-hardwaredesign/img/komponenten_elementar_led}}

            \column{.33\textwidth}
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/kennlinie-transistor} \\
            \smallskip
            \hfill \textbf{npn-Transistor} \hfill%
            \raisebox{-0.4\height}{\includegraphics[width=2.5em]{02-hardwaredesign/img/komponenten_elementar_transistor}}
        \end{columns}
    }
    \bigskip
...
\begin{frame}{Berechnung der Leistung}
    \begin{columns}
        \column{.4\textwidth}
        \begin{center}
            \includegraphics[width=.4\textwidth]{02-hardwaredesign/img/formel_pui}
        \end{center}
...
\begin{frame}{Gleichstrom vs. Wechselstrom}
    ...
    \begin{columns}
        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-gleichstrom}

        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-wechselstrom}

        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-analogsensor}
    \end{columns}
\end{frame}
...
\begin{frame}{Anforderungen des Raspberry Pi}
    \begin{columns}
        \column{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/raspi-stromarten}
...
%%% Folie
{
    \setbeamertemplate{background canvas}{
        \includegraphics[height=\paperheight, width=\paperwidth]{02-hardwaredesign/img/bauteile}
    }
...
\begin{frame}{Beispiel: Elementare Bauteile}
    \begin{columns}
        ...
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_widerstand} \\
        Widerstand

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_kondensator} \\
        Kondensator

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_diode} \\
        Diode

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_transistor} \\
        Transistor
    \end{columns}
    ...
    \begin{columns}
        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_quartz} \\
        Quartz-Kristal

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_drehregler} \\
        Drehregler

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_taster} \\
        Taster, Schalter

        \column[b]{.25\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_elementar_led} \\
        Leuchtdiode
    \end{columns}
\end{frame}
}
...
\begin{frame}{Beispiel: Integrierte Schaltkreise}
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_ic_prozessor} \\
        Mikroprozessor, Mikrocontroller

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_ic_speicher} \\
        Speicherbaustein
    \end{columns}
    ...
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_ic_logikgatter} \\
        Logikbaustein (AND, OR, XOR, ...)

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_ic_levelshifter} \\
        Level Shifter
    \end{columns}
\end{frame}
}
...
\begin{frame}{Beispiel: Vorgefertigte Baugruppen}
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_baugruppen_kamera} \\
        Kameramodul

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_baugruppen_rfid} \\
        RFID-Leser
    \end{columns}
    ...
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_baugruppen_display} \\
        Display

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_baugruppen_funk} \\
        Funkmodul
    \end{columns}
\end{frame}
}
...
\begin{frame}[allowframebreaks]{Beispiel: Sensorkit aus der Vorlesung}
    \begin{columns}
        \column{\dimexpr\paperwidth-28pt}
        \begin{center}
            \includegraphics[height=.8\textheight]{02-hardwaredesign/img/sensorkit_alle}
        \end{center}
    \end{columns}
...
\begin{frame}{Beispiel: Modular einsetzbare Geräte}
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_geraete_industriesteuerung} \\
        Industrielle Steuergeräte

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_geraete_smarthome} \\
    ...
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_geraete_ipkamera} \\
        IP-Kameras

        \column[b]{.5\textwidth}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/komponenten_geraete_zigbee} \\
...
{
    \setbeamertemplate{background canvas}{
        \includegraphics[height=\paperheight, width=\paperwidth]{02-hardwaredesign/img/vorgehen_lochrasterplatine}
    }
...
\begin{frame}{Häufig vorkommende Signalarten}
        ...
        \column[b]{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-binary} \\
    \end{columns}
    ...
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-pwm} \\

        \column[b]{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/strom-serial} \\
    \end{columns}
\end{frame}
...
\begin{frame}{Anschlüsse am Raspberry Pi}
        \begin{center}
            \includegraphics[height=0.5\textheight]{02-hardwaredesign/img/raspberry_anschluesse}
        \end{center}
...
\begin{frame}{Der J8 GPIO-Header im Detail}
        \begin{columns}
            \column[b]{.5\textwidth}
            \includegraphics[height=.7\textheight]{02-hardwaredesign/img/pinout}
            %\includegraphics[width=\textwidth]{02-hardwaredesign/img/raspberry_j8}
...
\begin{frame}{Bevor es losgehen kann: Maximale Grenzwerte}
    ...
    \bigskip
    \includegraphics[width=.75\textwidth]{02-hardwaredesign/img/stromentnahme-raspi-schaltplan}
...
\begin{frame}{Binärsignal ausgeben am Beispiel einer LED}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/led_direkt_circuitjs}
        \smallskip
        ...
        \column{0.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/led_direkt_foto}
    \end{columns}
\end{frame}
}
    ...
    \begin{columns}
        \begin{column}{.3\textwidth}
            \begin{center}
                ...
                \includegraphics[width=.7\textwidth]{02-hardwaredesign/img/komponenten_elementar_led}
            \end{center}
        \end{column}
...
\begin{frame}{Gemittelte Leistung durch Pulsweitenmodulation regulieren}
    ...
    \begin{center}
        \includegraphics[width=.8\textwidth]{02-hardwaredesign/img/pwm} \\
        \bigskip

        \includegraphics[width=.75\textwidth]{02-hardwaredesign/img/led_pwm_circuitjs}
    \end{center}
...
\begin{frame}{Pulsweitenmodulation am Beispiel eines Servomotors}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/servomotor-foto1}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/servomotor-foto2}
    \end{columns}
    ...
    \begin{columns}[onlytextwidth]
        ...
        \begin{block}{Hardwareskizze}
            \smallskip
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/servomotor-skizze}
        \end{block}

        \column[T]{.59\textwidth}
        \begin{block}{Schaltplan}
            \smallskip
            \includegraphics[width=\textwidth]{02-hardwaredesign/img/servomotor-schaltplan}
        \end{block}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Digitaleingang mit Active-High-Logik (z.B. Taster)}
    ...
    \begin{columns}
        \column{0.6\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/button_pulldown_circuitjs}
        \bigskip
        ...
        \column{0.4\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/button_pulldown_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Digitaleingang mit Active-Low-Logik (z.B. Lichtschranke)}
    ...
    \begin{columns}
        \column{0.6\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/button_pullup_circuitjs}
        \bigskip
        ...
        \column{0.4\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/button_pullup_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Serielle Datenübertragung am Beispiel des DHT11}
    ...
    \begin{columns}
        ...
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/dht11_schaltplan}

        \column[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/dht11_foto1}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/dht11_foto2}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Analogsignale messen mit einem A/D-Konverter}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/lautstaerke-foto1}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/lautstaerke-foto2}
    \end{columns}
    \medskip
    ...
    \includegraphics[width=\textwidth]{02-hardwaredesign/img/lautstaerke-schaltplan}
    \smallskip
...
\begin{frame}{Mittlere Lasten über Transistor schalten}
    ...
    \begin{columns}
        \column{0.6\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/led_transistor_circuitjs}
        \smallskip
        ...
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/led_transistor_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Große Lasten über Relais schalten}
    ...
    \begin{columns}
        \column{0.6\textwidth}
        \includegraphics[width=.9\textwidth]{02-hardwaredesign/img/led_relais_circuitjs}
        \smallskip
        ...
        \column{0.4\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/led_relais_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Inkompatible Logikpegel anpassen} % mit Transistor
    ...
    \begin{columns}
        \column{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/logiklevel_spannungsteiler}

        \column{.5\textwidth}
        \includegraphics[width=\textwidth]{02-hardwaredesign/img/logiklevel_transistor}
    \end{columns}
    \medskip
...
\begin{frame}{Exkurs: Spannungsteiler}
    \begin{columns}
        \column{0.7\textwidth}
        \includegraphics[width=.85\textwidth]{02-hardwaredesign/img/spannungsteiler}
...
%\begin{frame}{Module mit analoger Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/sensorkit_analog}
...
%\begin{frame}{Module mit digitaler An/Aus-Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/sensorkit_digital}
...
%\begin{frame}{Module mit serieller Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/sensorkit_seriell}
...
%\begin{frame}{Weitere serielle Schnittstellen}
    %\begin{columns}
        ...
        %\smallskip
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/seriell_uart_schaltplan}

        %\column[T]{.5\textwidth}
        %\textbf{Serial Peripheriel Interface (SPI)} \\
        %\smallskip
        %\includegraphics[width=0.8\textwidth]{02-hardwaredesign/img/seriell_spi_schaltplan}
    %\end{columns}
    ...
    %\smallskip
    %\includegraphics[width=\textwidth]{02-hardwaredesign/img/seriell_i2c_schaltplan}
%\end{frame}
%}
...
%\begin{frame}{Einsatzgebiete serieller Schnittstellen}
    ...
    %\begin{columns}
        %\column{.33\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/seriell_einsatz1}

        %\column{.33\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/seriell_einsatz2}

        %\column{.33\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/seriell_einsatz3}
    %\end{columns}
%\end{frame}
...
%\begin{frame}{Sowohl als auch: Belasteter Spannungsteiler}
    %\begin{columns}
        %\column{0.7\textwidth}
        %\includegraphics[width=.9\textwidth]{02-hardwaredesign/img/spannungsteiler_belastet}
...
%\begin{frame}{Fallbeispiel: Inkompatible Logiklevel anpassen}
    ...
    %\begin{center}
        %\includegraphics[width=.7\textwidth]{02-hardwaredesign/img/spannungsteiler_beispiel}
    %\end{center}
...
%\begin{frame}{Parallel geschaltete Widerstände: Stromteiler}
    %\begin{columns}
        %\column{0.7\textwidth}
        %\includegraphics[width=.9\textwidth]{02-hardwaredesign/img/stromteiler}
...
%\begin{frame}[allowframebreaks]{Vorgehen bei der Entwicklung einer neuen Schaltung}
    ...
    %\begin{columns}
        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/vorgehen_skizze}

        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/vorgehen_schaltplan}
    %\end{columns}
    ...
    %\begin{columns}
        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/vorgehen_breadboard}

        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{02-hardwaredesign/img/vorgehen_lochrasterplatine}
    %\end{columns}
%\end{frame}
