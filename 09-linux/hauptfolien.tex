...
\begin{frame}{Ausgangslage}
    ...
    \begin{columns}[b,onlytextwidth]
        \column{.48\textwidth}
        \begin{center}
            \includegraphics[width=.9\textwidth]{09-linux/img/c64}
        \end{center}
        \parbox{\linewidth}{
            \footnotesize
            \textbf{Commodore 64:}
        ...
        \column{.48\textwidth}
        \begin{center}
            \includegraphics[width=.85\textwidth]{09-linux/img/raspi}
        \end{center}
        \parbox{\linewidth}{
            \footnotesize
...
\begin{frame}{Beispiele für Linux-basierte Betriebssysteme}
    ...
    \includegraphics[width=\textwidth]{09-linux/img/linux-beispiele}
\end{frame}
...
\begin{frame}{Kernel vs. Userland}
    ...
    \vfill
    \includegraphics[width=\textwidth]{09-linux/img/linux-bestandteile}
\end{frame}
}
...
\begin{frame}{Partitionen und Dateisysteme auf dem Raspberry Pi}
    \includegraphics[width=\textwidth]{09-linux/img/pi-partitionen}
\end{frame}
...
\begin{frame}[allowframebreaks]{Der Linux Filesystem Hierarchy Standard}
    \begin{center}
        \includegraphics[width=\textwidth]{09-linux/img/fhs-verzeichnisse}
    \end{center}
    ...
    \begin{columns}[T]
        \column{.8\textwidth}
        \includegraphics[width=\textwidth]{09-linux/img/fhs-beispiele}
...
\begin{frame}[allowframebreaks]{Benutzer- und Rechteverwaltung unter Linux}
    \begin{columns}[onlytextwidth]
        \column{.55\textwidth}
        \includegraphics[width=\textwidth]{09-linux/img/rechte-dateizugriff}
    ...
    \begin{center}
        \includegraphics[width=\textwidth]{09-linux/img/rechte-konfiguration}
    \end{center}
...
\begin{frame}{Der Bootvorgang des Raspberry Pi im Detail}
    \includegraphics[width=\textwidth]{09-linux/img/pi-bootvorgang}
\end{frame}
...
\begin{frame}[allowframebreaks]{Automatischer Start der Systemdienste}
    \includegraphics[width=\textwidth]{09-linux/img/pid1-pstree}
    \medskip
    ...
    \begin{block}{Variante 1: Einfaches Shellskript}
        ...
        \lstinputlisting[language=bash]{09-linux/code/init.sh}
    \end{block}
    ...
    \begin{block}{Variante 2: SysV Init mit \texttt{/etc/inittab}}
        ...
        \vfill
        \lstinputlisting[language=bash]{09-linux/code/inittab}
    \end{block}
    ...
    \begin{block}{Variante 3: SystemD als moderner Standard}
        ...
        \lstinputlisting[language=Config]{09-linux/code/sshd.service}

        \smallskip
        \textbf{Befehle zum Aktivieren und Starten des Services}
        \lstinputlisting[language=bash]{09-linux/code/systemd-befehle.sh}
    \end{block}
\end{frame}
}
...
\begin{frame}{Fallbeispiel: Automatischer Start eines Pythonprogramms}
    \begin{columns}[onlytextwidth]
        \column{.58\textwidth}
        \includegraphics[width=\textwidth]{09-linux/img/systemd-beispiel-zipfile}
    ...
    \lstinputlisting[language=Config]{09-linux/code/iotdevice.service}
    ...
    \begin{columns}[onlytextwidth]
        \column{.5\textwidth}
        \lstinputlisting[language=Config, linerange={1-8}]{09-linux/code/iotdevice.install.sh}

        \column{.5\textwidth}
        \lstinputlisting[language=Config, linerange={9-16}, firstnumber=9]{09-linux/code/iotdevice.install.sh}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Generelles Vorgehen beim Bau eines Firmware-Images}
    ...
    \vfill
    \includegraphics[width=\textwidth]{09-linux/img/build-prinzip}
\end{frame}
...
\begin{frame}{Vergleich verschiedener Baukästen für Linux}
    \begin{columns}
        ...
        \begin{tabular}{p{.21\textwidth} p{.25\textwidth} p{.25\textwidth} p{.25\textwidth}}
            &
            \includegraphics[width=.10\textwidth]{09-linux/img/Debian-OpenLogo1} &
            \includegraphics[width=.08\textwidth]{09-linux/img/Buildroot-logo} &
            \includegraphics[width=.20\textwidth]{09-linux/img/Ubuntu_logo} \\
...
\begin{frame}{Linux-Images bauen mit pi-gen}
    ...
    \smallskip
    \includegraphics[width=\textwidth]{09-linux/img/pi-gen-dateien}
    \vskip 1em
...
\begin{frame}{Linux-Images bauen mit Buildroot}
        ...
        \smallskip
        \includegraphics[width=\textwidth]{09-linux/img/buildroot-menuconfig}
        \vskip 1em
