...
\begin{frame}{MQTT Architektur}
      \begin{figure}[!htb]
  \hspace*{5mm}
        \includegraphics[scale=0.15]{08-datenaustausch/img/mqttarch}
    \end{figure}
\end{frame}
...
\begin{frame}{MQTT Protokoll - Quality Of Service: Nachrichten}
   ...
   \begin{figure}[!htb]
       \hspace*{5mm}
        \includegraphics[scale=0.14]{08-datenaustausch/img/mqtt-qos}
    \end{figure}
\end{frame}
...
\begin{frame}{Limits in der Freien Version}
  \begin{figure}[!htb]
  \hspace*{5mm}
        \includegraphics[scale=0.6]{08-datenaustausch/img/adafruit-limits}
    \end{figure}
\end{frame}
...
\begin{frame}{MQTT Client Integration}
  ...
  \begin{figure}[!htb]
  \hspace*{2mm}
        \includegraphics[scale=0.4]{08-datenaustausch/img/mqttfxsettings}
    \end{figure}
\end{frame}
...
\begin{frame}{MQTT-over-WebSocket im Browser}
	...
	\centering
	\parbox{5cm}{
		\includegraphics[scale=0.19]{08-datenaustausch/img/websocket-mqtt-min}
		\caption{MQTT-over-Websockets Topic Subscription}
		\label{fig:wsmqttmin}
		}
	\qquad
	\begin{minipage}{5cm}
		\includegraphics[scale=0.27]{08-datenaustausch/img/websocket-mqtt}
...
\begin{frame}{Unterschiede bei Pub/Sub}
	...
	\centering
	\parbox{5cm}{
		\includegraphics[scale=0.19]{08-datenaustausch/img/mqtt-pubsub}
		\caption{Pub/Sub in MQTT}
		\label{fig:pubsubmqtt}
		}
	\qquad
	\begin{minipage}{5cm}
		\includegraphics[scale=0.15]{08-datenaustausch/img/adafruit-pubsub}
...
\begin{frame}{Adafruit IO: Python Code Beispiel}
    \begin{figure}
       \hspace*{2mm}
        \includegraphics[scale=0.28]{08-datenaustausch/img/adafruit-python-mqtt}
    \end{figure}
 \end{frame}
