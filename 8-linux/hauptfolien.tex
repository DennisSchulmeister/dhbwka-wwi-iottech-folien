...
\begin{frame}{Generelles Vorgehen beim Bau eines Firmware-Images}
    ...
    \vfill
    \includegraphics[width=\textwidth]{8-linux/img/build-prinzip}
\end{frame}
...
\begin{frame}{Vergleich verschiedener Baukästen für Linux}
    \begin{columns}
        ...
        \begin{tabular}{p{.21\textwidth} p{.25\textwidth} p{.25\textwidth} p{.25\textwidth}}
            &
            \includegraphics[width=.10\textwidth]{8-linux/img/Debian-OpenLogo1} &
            \includegraphics[width=.08\textwidth]{8-linux/img/Buildroot-logo} &
            \includegraphics[width=.20\textwidth]{8-linux/img/Ubuntu_logo} \\
...
\begin{frame}{Linux-Images bauen mit pi-gen}
    ...
    \smallskip
    \includegraphics[width=\textwidth]{8-linux/img/pi-gen-dateien}
    \vskip 1em
...
\begin{frame}{Linux-Images bauen mit Buildroot}
        ...
        \smallskip
        \includegraphics[width=\textwidth]{8-linux/img/buildroot-menuconfig}
        \vskip 1em
