...
\begin{frame}{Literaturempfehlungen}
    \begin{columns}
        ...
        \fbox{\includegraphics[height=3.8cm]{06-hardwarenutzung/img/buch_raspberrypi}}

        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{06-hardwarenutzung/img/buch_mqtt_essentials}}

        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{06-hardwarenutzung/img/buch_elektronik_dummies}}

        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{06-hardwarenutzung/img/buch_elektronik_fibel}}
    \end{columns}
...
\begin{frame}{Typischer Systemaufbau eingebetteter Systeme}
    \begin{columns}
        ...
        \only<beamer:1|handout:0>{
            \includegraphics[width=\paperwidth]{06-hardwarenutzung/img/mc_aufbau1}
        }

        \only<beamer:2|handout:1>{
            \transdissolve
            \includegraphics[width=\paperwidth]{06-hardwarenutzung/img/mc_aufbau2}
        }
    \end{columns}
...
\begin{frame}[allowframebreaks]{Fallbeispiel: Hindernisdetektor}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/hindernisdetektor-foto2}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/hindernisdetektor-foto1}
    \end{columns}
    ...
    \begin{block}{Hardwareskizze}
        \smallskip
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/hindernisdetektor-skizze}
    \end{block}

    \framebreak
    \begin{block}{Schaltplan}
        \smallskip
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/hindernisdetektor-schaltplan}
        {
            \scriptsize
    ...
    \begin{block}{Hardwareaufbau}
        ...
        \begin{columns}[onlytextwidth]
            ...
            \includegraphics[width=\textwidth]{06-hardwarenutzung/img/breadboard1_bb}

            \column[T]{.49\textwidth}
            \includegraphics[width=\textwidth]{06-hardwarenutzung/img/breadboard2_bb}
        \end{columns}
    ...
    \begin{columns}
        \column{.65\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/hindernisdetektor_bb}
...
\begin{frame}{Fallbeispiel: Servomotor}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/servomotor-foto1}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/servomotor-foto2}
    \end{columns}
    ...
    \begin{columns}[onlytextwidth]
        ...
        \begin{block}{Hardwareskizze}
            \smallskip
            \includegraphics[width=\textwidth]{06-hardwarenutzung/img/servomotor-skizze}
        \end{block}

        \column[T]{.59\textwidth}
        \begin{block}{Schaltplan}
            \smallskip
            \includegraphics[width=\textwidth]{06-hardwarenutzung/img/servomotor-schaltplan}
        \end{block}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Wiederholung: Pulsweitenmodulation}
    ...
    \begin{center}
        \includegraphics[width=.75\textwidth]{06-hardwarenutzung/img/pwm}
    \end{center}

    \begin{columns}
        \column{.5\textwidth}
        \includegraphics[width=.9\textwidth]{06-hardwarenutzung/img/led_pwm_schaltplan}

        \column{.5\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/led_pwm_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Quellcodes}
    ...
    \fbox{\includegraphics[width=\textwidth]{06-hardwarenutzung/img/github-servomotor}}
\end{frame}
...
\begin{frame}{Einsatzgebiete serieller Schnittstellen}
    ...
    \begin{columns}
        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/seriell_einsatz1}

        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/seriell_einsatz2}

        \column{.33\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/seriell_einsatz3}
    \end{columns}
\end{frame}
...
\begin{frame}{Funktionsweise der seriellen Datenübertragung}
    \begin{columns}
        ...
        \medskip
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/seriell_arten}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Verdrahtung von SPI und I²C}
    \begin{block}{Serial Peripherial Interface (SPI)}
        \smallskip
        \includegraphics[width=.8\textwidth]{06-hardwarenutzung/img/seriell_spi_schaltplan}
        \smallskip
        \includegraphics[width=.9\textwidth]{06-hardwarenutzung/img/seriell_spi_timing}
    \end{block}

    \begin{block}{Inter-Integrated Circuit (I²C)}
        \smallskip
        \includegraphics[width=.8\textwidth]{06-hardwarenutzung/img/seriell_i2c_schaltplan}
    \end{block}
\end{frame}
...
\begin{frame}{Fallbeispiel: Lautstärkenmessung via A/D-Konverter}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/lautstaerke-foto1}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/lautstaerke-foto2}
    \end{columns}
    ...
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{06-hardwarenutzung/img/lautstaerke-skizze}
    ...
    \bigskip
    \includegraphics[width=\textwidth]{06-hardwarenutzung/img/lautstaerke-schaltplan}
\end{frame}
}
...
\begin{frame}{Quellcodes}
    ...
    \smallskip
    \setlength{\fboxsep}{0em}
    \fbox{\includegraphics[width=\textwidth]{06-hardwarenutzung/img/github-lautstaerke}}
\end{frame}
