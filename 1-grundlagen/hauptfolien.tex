...
\begin{frame}{Literaturempfehlungen}
    \begin{columns}
        ...
        \column[b]{.33\textwidth}
        \fbox{\includegraphics[height=3.8cm]{1-grundlagen/img/buch_practical_electronics}}
    ...
    \begin{columns}
        \begin{column}[b]{.5\textwidth}
            \begin{block}{Projektentwicklung}
                \medskip
                %\begin{center}
                    \includegraphics[width=.4\textwidth]{1-grundlagen/img/sbc-boards}
                %\end{center}
        ...
        \begin{column}[b]{.5\textwidth}
            \begin{block}{Produktentwicklung}
                \medskip
                %\begin{center}
                    \includegraphics[width=.4\textwidth]{1-grundlagen/img/microchip}
                %\end{center}
...
\begin{frame}{Mikroprozessoren für eingebettete Systeme}
    \begin{columns}
        \column{.2\textwidth}
        \includegraphics[width=.9\linewidth]{1-grundlagen/img/intel486}
    ...
    \begin{columns}
        \column{.2\textwidth}
        \includegraphics[width=.9\linewidth]{1-grundlagen/img/AVR-ATmega}
    ...
    \begin{columns}
        \column{.2\textwidth}
        \includegraphics[width=.9\linewidth]{1-grundlagen/img/ARM-Cortex}
...
\begin{frame}[allowframebreaks]{Fallbeispiel: Yamaha SPX90 (1985)}
    \begin{center}
        \includegraphics[width=\textwidth]{1-grundlagen/img/spx90-foto}
    \end{center}
    ...
    \begin{columns}
        \column[b]{.5\textwidth}
        \includegraphics[width=\textwidth]{1-grundlagen/img/spx90-schaltplan-1}

        \column[b]{.5\textwidth}
        \includegraphics[width=\textwidth]{1-grundlagen/img/spx90-schaltplan-2}
    \end{columns}

    \bigskip

    \includegraphics[width=\textwidth]{1-grundlagen/img/spx90-cpuboard}
\end{frame}
...
\begin{frame}{Fallbeispiel: IoT-Device mit Sensoren und Aktoren}
    ...
    \includegraphics[width=\textwidth]{1-grundlagen/img/einparkhilfe_bb}
\end{frame}
...
\begin{frame}{Was nutzen wir in der Vorlesung?}
    \begin{center}
        \includegraphics[width=\textwidth]{1-grundlagen/img/raspi-linux-python}
    \end{center}
