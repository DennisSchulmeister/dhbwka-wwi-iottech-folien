...
\begin{frame}{Mittlere Lasten über Transistor schalten}
    \Justified{
        ...
        Der hier gezeigte ,,NPN-Transistor'' funktioniert im einfachste Fall wie ein
        \textbf{spannungsgesteuerter Schalter}. Ein kleiner Strom an der Basis steuert,
        in wiefern ein viel größerer am Collector anliegender Strom durchgelassen wird.
        Die Summe beider Ströme (in Ampére) fließt durch den Emitter nach Ground.
        \smallskip
...
%\begin{frame}{Module mit analoger Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{img/sensorkit_analog}
...
%\begin{frame}{Module mit digitaler An/Aus-Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{img/sensorkit_digital}
...
%\begin{frame}{Module mit serieller Schnittstelle}
    %\begin{columns}
        %\column{.6\textwidth}
        %\includegraphics[width=\textwidth]{img/sensorkit_seriell}
...
%\begin{frame}[allowframebreaks]{Vorgehen bei der Entwicklung einer neuen Schaltung}
    ...
    %\begin{columns}
        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{img/vorgehen_skizze}

        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{img/vorgehen_schaltplan}
    %\end{columns}
    ...
    %\begin{columns}
        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{img/vorgehen_breadboard}

        %\column{0.5\textwidth}
        %\includegraphics[width=\textwidth]{img/vorgehen_lochrasterplatine}
    %\end{columns}
%\end{frame}
