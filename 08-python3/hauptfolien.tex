...
\begin{frame}{Enge Kopplung}
    	  \begin{figure}[!htb]
        \includegraphics[scale=0.5]{08-python3/img/tightcoupling}
    \end{figure}
\end{frame}
...
\begin{frame}{Besonderheiten in Python: Mixins}
   \begin{figure}[!htb]
        \includegraphics[scale=0.37]{08-python3/img/mixins}  %https://www.ianlewis.org/en/mixins-and-python
    \end{figure}
...
\begin{frame}{Anwendungsfall: Testing mit MagicMock}
   \begin{figure}[!htb]
        \includegraphics[scale=0.47]{08-python3/img/magicmock}
    \end{figure}
...
\begin{frame}{Observer Pattern 1}
       \begin{figure}[!htb]
        \includegraphics[scale=0.67]{08-python3/img/observer}
    \end{figure}
...
\begin{frame}{Publish-Subscribe 2}
      \begin{figure}[!htb]
        \includegraphics[scale=0.67]{08-python3/img/pubsub}
    \end{figure}
...
\begin{frame}{Raspberry PI 3 und Nebenläufigkeit}
  ...
  \begin{figure}[!htb]
  \hspace*{-4cm}
        \includegraphics[scale=0.075]{08-python3/img/raspi3}  %https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Rasperry_pi_3_model_b_v1.3_bot.jpg/2560px-Rasperry_pi_3_model_b_v1.3_bot.jpg
    \end{figure}
...
\begin{frame}{Raspberry PI 3 Cluster}
	  \begin{figure}[!htb]
        \includegraphics[scale=0.23]{08-python3/img/raspi3cluster}  %https://www-users.cs.york.ac.uk/~mjf/pi_cluster/Images/cluster1.jpg
    \end{figure}
...
\begin{frame}{Python Multiprocessing Beispiel: Annhäherung von $\pi$} %https://gist.github.com/amitsaha/2036026
      \begin{figure}[!htb]
        \includegraphics[scale=0.27]{08-python3/img/multiprocessing_picalc}
    \end{figure}
...
\begin{frame}{Beispiel Ping mit Threads}
  %https://www.python-kurs.eu/threads.php
    \begin{figure}[!htb]
        \includegraphics[scale=0.23]{08-python3/img/pingthreads}
    \end{figure}
...
\begin{frame}{Queue Beispiel: Producer $\Rightarrow$  Consumer} %https://www.agiliq.com/blog/2013/10/producer-consumer-problem-in-python/
     \begin{figure}[!htb]
        \includegraphics[scale=0.31]{08-python3/img/producerconsumer}
    \end{figure}
\end{frame}
...
\begin{frame}{Beispiel Coroutines: Abfrage Wetterdaten für Städte} %https://dev.to/welldone2094/async-programming-in-python-with-asyncio-12dl
         \begin{figure}[!htb]
           \hspace*{-0.5cm}
        \includegraphics[scale=0.31]{08-python3/img/coroutine_download}
    \end{figure}
\end{frame}
