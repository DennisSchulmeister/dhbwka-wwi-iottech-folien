...
\begin{frame}{Literaturempfehlungen}
    \begin{columns}
        ...
        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{img/buch_mqtt_essentials}}

        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{img/buch_elektronik_dummies}}

        \column[b]{.25\textwidth}
        \fbox{\includegraphics[height=3.8cm]{img/buch_elektronik_fibel}}
    \end{columns}
...
\begin{frame}{Typischer Systemaufbau eingebetteter Systeme}
    \begin{columns}
        ...
        \only<beamer:1|handout:0>{
            \includegraphics[width=\paperwidth]{img/mc_aufbau1}
        }

        \only<beamer:2|handout:1>{
            \transdissolve
            \includegraphics[width=\paperwidth]{img/mc_aufbau2}
        }
    \end{columns}
...
\begin{frame}[allowframebreaks]{Fallbeispiel: Hindernisdetektor}
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{img/hindernisdetektor-foto2}

        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{img/hindernisdetektor-foto1}
    \end{columns}
    ...
    \begin{block}{Hardwareskizze}
        \smallskip
        \includegraphics[width=\textwidth]{img/hindernisdetektor-skizze}
    \end{block}

    \framebreak
    \begin{block}{Schaltplan}
        \smallskip
        \includegraphics[width=\textwidth]{img/hindernisdetektor-schaltplan}
        {
            \scriptsize
    ...
    \begin{block}{Hardwareaufbau}
        ...
        \begin{columns}[onlytextwidth]
            ...
            \includegraphics[width=\textwidth]{img/breadboard1_bb}

            \column[T]{.49\textwidth}
            \includegraphics[width=\textwidth]{img/breadboard2_bb}
        \end{columns}
    ...
    \begin{columns}
        \column{.65\textwidth}
        \includegraphics[width=\textwidth]{img/hindernisdetektor_bb}
...
\begin{frame}{Wiederholung: Pulsweitenmodulation}
    ...
    \begin{center}
        \includegraphics[width=.75\textwidth]{img/pwm}
    \end{center}

    \begin{columns}
        \column{.5\textwidth}
        \includegraphics[width=.9\textwidth]{img/led_pwm_schaltplan}

        \column{.5\textwidth}
        \includegraphics[width=\textwidth]{img/led_pwm_foto}
    \end{columns}
\end{frame}
}
...
\begin{frame}{Verdrahtung von SPI und I²C}
    \begin{block}{Serial Peripherial Interface (SPI)}
        \smallskip
        \includegraphics[width=.8\textwidth]{img/seriell_spi_schaltplan}
        \smallskip
        \includegraphics[width=.9\textwidth]{img/seriell_spi_timing}
    \end{block}

    \begin{block}{Inter-Integrated Circuit (I²C)}
        \smallskip
        \includegraphics[width=.8\textwidth]{img/seriell_i2c_schaltplan}
    \end{block}
\end{frame}
...
\begin{frame}{Fallbeispiel: Lautstärkenmessung via A/D-Konverter}
    ...
    \begin{columns}[onlytextwidth]
        \column{.49\textwidth}
        \includegraphics[width=\textwidth]{img/lautstaerke-skizze}
...
\begin{frame}{Quellcodes}
    ...
    \smallskip
    \setlength{\fboxsep}{0em}
    \fbox{\includegraphics[width=\textwidth]{img/github-lautstaerke}}
\end{frame}
