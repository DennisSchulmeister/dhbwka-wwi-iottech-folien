...
set output 'strom-pwm.pdf'

set title "{/:Bold Pulsweitenmodulation}\n10 Hz, 20% / 70% / 40% Lastzyklus" font ",16"
...
plot [0:0.3] [-0.1:3.4] "strom-pwm.txt" with lines

#-------------------------------------------------------------------------------
set terminal png transparent enhanced lw 12 size 1600,1200 font 'Arial'
set output 'strom-pwm-klein.png'
