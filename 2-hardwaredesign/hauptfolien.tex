...
\begin{frame}[allowframebreaks]{Was ist elektrischer Strom?}
    ...
    \parbox{\linewidth}{
        \scriptsize
        Im Normalzustand sind Atome elektrisch neutral, da sie die gleiche Anzahl
        Protonen wie Elektronen besitzen. Atome mit einem Überschuss oder Mangel
        an Elektronen werden \textbf{Ionen} genannt und sind \textbf{elektrisch
        geladen}. Wurde beispielsweise ein Elektron aus der äußeren Hülle
        eines Atoms heraus gelöst, kann ein benachbartes Elektron überspringen,
        wodurch Strom fließt.
        \smallskip
...
\begin{frame}[allowframebreaks]{Das Ohmsche Gesetz}
    \begin{columns}
        ...
        \begin{tabular}{ccll}
            $U$ & = & $R \cdot I$ & {\scriptsize Spannung in Volt} \\
...
\begin{frame}{Berechnung der Leistung}
    \begin{columns}
        ...
        \column{.6\textwidth}
        \begin{tabular}{ccll}
            $P$ & = & $U \cdot I$ & {\scriptsize Leistung in Watt} \\
    ...
    \Justified{
        ...
        verfügbare Energie bezeichnet. Ihre elektrische Definition lautet $P = U \cdot I$,
...
\begin{frame}{Inkompatible Logikpegel anpassen} % mit Transistor
    \Justified{
        ...
        ältere Geräte nutzen 5\,V, während heutzutage eine wesentlich kleinere Spannungen
...
%%\begin{frame}{TODO}
    ...
    %%\href{%
        %%https://www.falstad.com/circuit/circuitjs.html?ctz=CQAgjCAMB0l3BWcMBMcUHYMGZIA4UA2ATmIxAUgoqoQFMBaMMAKADcQdCRs8AWTtm4o+VKhFHIo0mAhYAnQcMl48VEWJBo4CkKvWSwkSRulGdAd2QnDxqrwGQWVo5IdKe-KCwAOeteCE4naB4jLO-uJBkVqSTi4hYNGuBmIsAB6chBBE5EaYWhhUAmAoIABaFnQAlgA6AM4A6tUAJnTy9QAuACcAdm0N1b0NAEo1ABZ0AFwNAMo+AIa9vQCuvQDmXTUANu0ZeoTcYNhlKeDYSCVlALJ09fVr6w1t8g0AKjv1i8uPdL2+HiSVH0oXA4SsXFBkNMTgA9tRCI4QKJiHgpDAIOp0SwgA
    %%}{
        %%\beamergotobutton{Online ausprobieren}
    %%}
%%\end{frame}
