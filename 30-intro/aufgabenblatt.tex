...
%-------------------------------------------------------------------------------
\aufgabe{Single Board Computer im Vergleich}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\aufgabe{Rechnerarchitektur im Detail}
%-------------------------------------------------------------------------------
%\teilaufgabe
...
Die folgenden zwei Abbildungen zeigen hierfür das Blockdiagramm eines einfachen,
...
\bigskip
\includegraphics[width=\textwidth]{img/aufgabe-rechnerarchitektur-1}

\includegraphics[width=\textwidth]{img/aufgabe-rechnerarchitektur-2}
\bigskip
...
\begin{tabular}{p{.33\textwidth}p{.33\textwidth}p{.33\textwidth}}
    \raisebox{-\height+1em}{
        \includegraphics[width=.9\linewidth]{img/sbc_microprozessor2_klein}
    }
...
\teilaufgabe
Abgrenzung der Begriffe \textbf{Mikroprozessor}, \textbf{Microcontroller} und
\textbf{System-on-a-Chip}:
...
%-------------------------------------------------------------------------------
\loesung{Single Board Computer im Vergleich}
%-------------------------------------------------------------------------------
Die Daten müssen Sie schon selbst recherchieren. \smiley

%-------------------------------------------------------------------------------
\loesung{Rechnerarchitektur im Detail}
%-------------------------------------------------------------------------------
%\teilaufgabe
