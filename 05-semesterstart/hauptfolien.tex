...
\begin{frame}{Literaturempfehlungen}
    \begin{columns}
        ...
        \fbox{\includegraphics[height=3.8cm]{01-grundlagen/img/buch_raspberrypi}}

        \column[b]{.33\textwidth}
        \fbox{\includegraphics[height=3.8cm]{01-grundlagen/img/buch_practical_electronics}}

        \column[b]{.33\textwidth}
        \fbox{\includegraphics[height=3.8cm]{01-grundlagen/img/buch_embedded_hardware}}
    \end{columns}
...
\begin{frame}{Beispiel einer typischen IoT-Architektur}
    \begin{columns}
        ...
        \includegraphics[width=\textwidth]{05-semesterstart/img/systemarchitektur}
    \end{columns}
\end{frame}
...
\begin{frame}{Asynchrone Kommunikation mit MQTT}
    \begin{center}
        \includegraphics[width=.9\textwidth]{05-semesterstart/img/mqtt-beispiel}
    \end{center}
...
\begin{frame}{Provisionierung und Deployment mit Balena}
    \begin{columns}
        ...
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-motivation}
    \end{columns}
\end{frame}
...
\begin{frame}{Grundprinzip der Balena Cloud}
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-funktionsweise}
    \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{Deviceseitige Beispielarchitektur}
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \scriptsize
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-beispielarchitektur}
    ...
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-grafana}
    ...
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-webui}
    ...
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-cli}
        \textsc{Balena CLI}
    \end{columns}
\end{frame}
...
\begin{frame}{Benötigte Entwicklungswerkzeuge}
    \begin{columns}
        \column{\dimexpr\paperwidth-10pt}
        \includegraphics[width=\textwidth]{05-semesterstart/img/balena-werkzeuge}
    \end{columns}
\end{frame}
...
\begin{frame}{Praxisbeispiele}
    \begin{block}{R2R-Kette zur Erzeugung von Analogsignalen}
        ...
        \begin{columns}
            \column{0.5\textwidth}
            \includegraphics[width=\textwidth]{05-semesterstart/img/r2r-dac}
            \bigskip
    ...
    \begin{block}{Scan-Matrix zum Auslesen vieler Schalter}
        ...
        \begin{columns}
            \column{0.5\textwidth}
            \includegraphics[width=.9\textwidth]{05-semesterstart/img/keyscanmatrix}
            \bigskip
