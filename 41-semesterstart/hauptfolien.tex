...
\begin{frame}{Aufgabe: Entwurf eines mobilen Datenloggers}
    ...
    \begin{block}{Hardware}
        ...
        \begin{columns}
            ...
            \includegraphics[width=\textwidth]{99-beispieleraspberrypi}

            \column[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{99-beispielearduino}

            \column[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{99-beispieleesp8266}

            \column[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{99-beispielepi-pico}
        \end{columns}
        \begin{columns}
            \column[b]{0.2\textwidth}
