...
\begin{frame}[allowframebreaks]{Aufgabe: Redis Tutorial}
    \setlength{\fboxsep}{0em}
    \fbox{\includegraphics[width=\linewidth]{06-architektur/img/redis-tutorial}}
...
\begin{frame}{Zunehmende Komplexität bei P2P}
    \begin{columns}
        \column{.6\textwidth}
        \includegraphics[width=\textwidth]{06-architektur/img/mqtt4}
...
\begin{frame}{MQTT-Zustellungsgarantien}
    \begin{columns}
        \column{.65\textwidth}
        \includegraphics[width=\textwidth]{06-architektur/img/mqtt-qos}
...
\begin{frame}{Aufgabe: MQTT im Browser ausprobieren}
    \begin{columns}
        \column{.5\textwidth}
        \setlength{\fboxsep}{0em}
        \fbox{\includegraphics[width=\linewidth]{06-architektur/img/public-mqtt-broker1}}

        \column{.5\textwidth}
        \setlength{\fboxsep}{0em}
        \fbox{\includegraphics[width=\linewidth]{06-architektur/img/public-mqtt-broker2}}
    \end{columns}
